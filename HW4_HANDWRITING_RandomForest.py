...
y = np.vstack((np.ones((np.shape(train0)[0],1)), np.zeros((900,1))))
...
clf0 = RandomForestClassifier(criterion = "entropy")
...
clf6 = RandomForestClassifier(criterion = "entropy")
clf7 = RandomForestClassifier(criterion = "entropy")
clf8 = RandomForestClassifier(criterion = "entropy")
clf9 = RandomForestClassifier(criterion = "entropy")

#90 and 95% dimensionality reduction
clf0_90 = RandomForestClassifier(criterion = "entropy")
clf0_95 = RandomForestClassifier(criterion = "entropy")

clf1_90 = RandomForestClassifier(criterion = "entropy")
clf1_95 = RandomForestClassifier(criterion = "entropy")

clf2_90 = RandomForestClassifier(criterion = "entropy")
clf2_95 = RandomForestClassifier(criterion = "entropy")

clf3_90 = RandomForestClassifier(criterion = "entropy")
clf3_95 = RandomForestClassifier(criterion = "entropy")

clf4_90 = RandomForestClassifier(criterion = "entropy")
clf4_95 = RandomForestClassifier(criterion = "entropy")

clf5_90 = RandomForestClassifier(criterion = "entropy")
clf5_95 = RandomForestClassifier(criterion = "entropy")

clf6_90 = RandomForestClassifier(criterion = "entropy")
clf6_95 = RandomForestClassifier(criterion = "entropy")

clf7_90 = RandomForestClassifier(criterion = "entropy")
clf7_95 = RandomForestClassifier(criterion = "entropy")

clf8_90 = RandomForestClassifier(criterion = "entropy")
clf8_95 = RandomForestClassifier(criterion = "entropy")

clf9_90 = RandomForestClassifier(criterion = "entropy")
clf9_95 = RandomForestClassifier(criterion = "entropy")
...
#train all support vectors with reduced data
...
plt.title("Confusion matrix for Random Forest Unreduced Data")
cfm_plot = sn.heatmap(dat_Confusion, annot=True)

plt.figure(figsize = (10,7))
plt.title("Confusion matrix for Random Forest 90% Data")
cfm_plot = sn.heatmap(dat_Confusion_90, annot=True)

plt.figure(figsize = (10,7))
plt.title("Confusion matrix for Random Forest 95% Data")
...
Accuracy_mean_90= np.mean(Accuracy_90, axis=1)   
Accuracy_mean_95 = np.mean(Accuracy_95, axis=1)         
...
plt.title("Comparison of Accuracy for Random Forest Classification with PCA Reduced Data")
plt.bar(["Unreduced", "90%", "95%"], np.ravel([Accuracy_mean, Accuracy_mean_90, Accuracy_mean_95]))
